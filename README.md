...
> 1) 첫번째 Frame은 Prediction을 하지 않고 두 번째부터 진행됩니다.   
> 2) Prediction은 이전 Frame의 원본과 비교하여 진행됩니다.  
> 3) Prediction Image와 Original Image를 비교하여 PSNR을 측정할 수 있습니다.  
> 4) Prediction Image는 Residual Error값이 아닌 현재 처리중인 Block의 값과 유사하다고 판단된 이전 Frame의 Block의 값을 현재 처리중인 Block값으로 넣어줍니다.   
